    ...
    <div class="p-6 bg-white border border-gray-200 rounded shadow dark:bg-gray-800 dark:border-gray-700">
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Cette image sera utilisée comme visuel principal dans votre article</p>
                @error('cover_image')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const contentEditor = new EasyMDE({
                ...
                uploadImage: false,
                imageUploadFunction: null, // Vous pourriez implémenter une fonction d'upload personnalisée ici
                unorderedListStyle: "-",
                orderedListStyle: "1."
            });
